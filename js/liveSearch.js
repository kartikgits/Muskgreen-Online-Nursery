...
function init(){
	...
	//xmlHttp.async = false;
	xmlHttp.open("GET","xml/links.xml",false);
	xmlHttp.send(null);
	
	var xmlDoc = xmlHttp.responseXML;
	
	// Pull out the quote and author elements
	var nTitle = xmlDoc.getElementsByTagName('title');
	...
	{
		 arrTitle.push(nTitle[i].childNodes[0].nodeValue);
	}
...
/*An array containing all product names:*/
var products = init();
